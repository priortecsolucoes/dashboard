        ...
        for node in nodes:
            try:
                ...
                if (nodeDateTime <= today) and \
                   (nodeMotivation in self.motivations or nodeMotivation == "") and \
    ...
    def processNotBillableQueries(self):
        ...
        for node in nodes:
            try:
                ...
                if nodeDateTime <= today and (nodeMotivation in self.motivations or nodeMotivation == "") and (nodeStatus is None or nodeStatus == ""):
    ...
    def processBillableQueries(self):
        ...
        for node in nodes:
            try:
                ...
                if nodeDateTime <= today and (nodeMotivation in self.motivations or nodeMotivation == "") and nodeStatus == "aprovado":
    ...
    def processDeniedQueries(self):
        ...
        for node in nodes:
            try:
                ...
                if nodeDateTime <= today and (nodeMotivation in self.motivations or nodeMotivation == "") and nodeStatus == "negado":
    ...
    def processIneligibleQueries(self):
        ...
        for node in nodes:
            try:
                ...
                if nodeDateTime <= today and (nodeMotivation in self.motivations or nodeMotivation == "") and nodeStatus == "inelegível":
