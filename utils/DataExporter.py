    ...
    def processNotBillableQueries(self):
        ...
        for node in nodes:
            try:
                ...
                if nodeDateTime <= today and (nodeStatus is None or nodeStatus == ""):
    ...
    def processBillableQueries(self):
        ...
        for node in nodes:
            try:
                ...
                if nodeDateTime <= today and nodeStatus == "aprovado":
    ...
    def processDeniedQueries(self):
        ...
        for node in nodes:
            try:
                ...
                if nodeDateTime <= today and nodeStatus == "negado":
    ...
    def processIneligibleQueries(self):
        ...
        for node in nodes:
            try:
                ...
                if nodeDateTime <= today and nodeStatus == "inelegível":
